...
// централизованно на ВСЕХ страницах разом (обёртка apiFetch покрывала только
// рабочий экран). refresh-токен живёт 30 дней, поэтому активный пользователь не
// теряет действие и не выбрасывается.
