...
function IconScales() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v18M8 21h8M3 7l4-1 4 1M13 7l4-1 4 1M7 6l-4 7a4 4 0 0 0 8 0zM17 5l-4 7a4 4 0 0 0 8 0z"/></svg>
}
...
function IconHelp() {
  return <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--ink-4)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
}
...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: '/templates', label: 'Шаблоны', icon: <IconTemplate /> },
    ...
    return navGroups.map((group) => {
      ...
      return {
        ...
        items: [
          ...
          { href: '/admin/legal', label: 'Юридическая база', icon: <IconScales /> },
        ],
      }
    })
  }, [isAdmin])
    ...
    <>
      ...
      <div className="border-t border-[var(--line)] px-[12px] py-[12px] shrink-0">
        ...
        <Link
          href="/support"
          onClick={onNavClick}
          className="flex items-center gap-[8px] w-full px-[10px] py-[5px] rounded-[var(--radius-md)] hover:bg-[var(--surface-inset)] cursor-pointer transition-colors duration-[120ms] mt-[2px] no-underline"
        >
          <IconHelp />
          <span className="text-[12px] text-[var(--ink-4)]">Поддержка</span>
        </Link>
        <button
          onClick={async () => {
